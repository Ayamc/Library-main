const icons = {
    ...
    copyright: () => {
        return `<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 3.34a10 10 0 1 1 -14.995 8.984l-.005 -.324l.005 -.324a10 10 0 0 1 14.995 -8.336zm-2.34 5.659a4.016 4.016 0 0 0 -5.543 .23a3.993 3.993 0 0 0 0 5.542a4.016 4.016 0 0 0 5.543 .23a1 1 0 0 0 -1.32 -1.502c-.81 .711 -2.035 .66 -2.783 -.116a1.993 1.993 0 0 1 0 -2.766a2.016 2.016 0 0 1 2.783 -.116a1 1 0 0 0 1.32 -1.501z" stroke-width="0" fill="currentColor" />`;
    },
    mail: () => {
        return `
    ...
    dashboard: () => {
        return `<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4h6v8h-6z" /><path d="M4 16h6v4h-6z" /><path d="M14 12h6v8h-6z" /><path d="M14 4h6v4h-6z" />`;
    },
    userScan: () => {
        return `
    ...
    video: () => {
        return `
                <g clip-path="url(#clip0_59_153)">
                    <path d="M5.25 3.66689V16.3336C5.24996 16.4744 5.28751 16.6127 5.35876 16.7342C5.43002 16.8558 5.5324 16.9561 5.65535 17.0248C5.7783 17.0935 5.91737 17.1282 6.0582 17.1253C6.19903 17.1223 6.33653 17.0819 6.4565 17.0081L16.7482 10.6747C16.8634 10.6039 16.9586 10.5047 17.0247 10.3866C17.0907 10.2685 17.1254 10.1355 17.1254 10.0002C17.1254 9.86493 17.0907 9.7319 17.0247 9.61382C16.9586 9.49574 16.8634 9.39655 16.7482 9.32572L6.4565 2.99239C6.33653 2.91858 6.19903 2.87811 6.0582 2.87517C5.91737 2.87223 5.7783 2.90692 5.65535 2.97565C5.5324 3.04439 5.43002 3.14469 5.35876 3.2662C5.28751 3.38771 5.24996 3.52603 5.25 3.66689Z" fill="#F3F3F6" />
                </g>
                <defs>
    ...
    users: () => {
        return `<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" />
        `;
    },
    clipboardList: () => {
        return `
    ...
    layers: () => {
        return `<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 4m0 2a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2z" /><path d="M4 8m0 2a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2z" />`;
    },
    shield: () => {
        return `
    ...
    check: () => {
        return `<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l5 5l10 -10" />`;
    },
    X: () => {
        return '<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 6l-12 12" /><path d="M6 6l12 12" />';
    },
    arrowUp: () => {
        return '<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14" /><path d="M18 11l-6 -6" /><path d="M6 11l6 -6" />';
    },
    exclamationMark: () => {
        return '<path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 19v.01" /><path d="M12 15v-10" />';
    }
};
